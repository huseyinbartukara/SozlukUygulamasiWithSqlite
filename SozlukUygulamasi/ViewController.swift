...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        kelimeListesi = Kelimelerdao().tumKelimelerAl()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let indeks = sender as? Int // tıklanılan satırın indeks numarası
...
extension ViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let hucre = tableView.dequeueReusableCell(withIdentifier: "kelimeHucre", for: indexPath) as! KelimeHucreTableViewCell
        
        hucre.ingilizceLabel.text = kelime.ingilizce
        hucre.turkceLabel.text = kelime.turkce
